...
func TestClient_StoreTask(t *testing.T) {
	...
	client.StoreTask(t.Context(), "task-1", "ctx-1", "user text", "agent text", "completed", nil, auth)
...
func TestClient_DisabledWhenNoEndpoint(t *testing.T) {
	...
	client.StoreTask(t.Context(), "task", "ctx", "u", "a", "completed", nil, kagentapi.AuthInfo{})
}
