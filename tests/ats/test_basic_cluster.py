...
deployment_name = "klaus-gateway"
namespace_name = "klaus-gateway"
...
def deployment(kube_cluster: Cluster) -> List[pykube.Deployment]:
    logger.info("Waiting for klaus-gateway deployment..")
    ...
    logger.info("klaus-gateway deployment looks satisfied..")
